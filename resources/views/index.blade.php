...
<head>
    ...
    <div class="main--body">
        ...
        <section class="banner-section" id="home">
            ...
            <div class="banner-bg d-none d-lg-block bg_img" data-background="https://ameristock.net/assets/images/banner/banner.jpg">
        ...
        <section class="feature-section padding-top padding-bottom bg_img" data-background="./https://ameristock.com/https://ameristock.net/assets/images/feature/feature-bg.png" id="feature">
                                ...
                                <ul class="tab-menu">
                                    ...
                                    <li>
                                        ...
                                        <div class="menu-content">
                                            ...
                                            <p>
                                                <a href="#0">Login</a> into your account and make payments to start earning the profit.
                                            </p>
                                        </div>
                                    </li>
                                    <li>
                        ...
                        <div class="offer-body">
                            ...
                            <div class="item first">
                                ...
                                <div class="item-content">
                                    ...
                                    <h5 class="subtitle"><span class="min">$200</span><span class="to">to</span><span class="max">$1000</span></h5>
                                </div>
                            </div>
                            <span class="bal-shape"></span>
                            <div class="item">
        ...
        <section class="latest-transaction padding-top padding-bottom" id="transaction">
            <div class="transaction-bg bg_img" data-background="https://ameristock.net/assets/images/transaction/transaction-bg.png">
        ...
        <!--=======Check-Section Starts Here=======-->
        <section class="call-section call-overlay bg_img" data-background="https://ameristock.net/assets/images/call/call-bg.jpg">
            <div class="container">
                <div class="row align-items-center">
