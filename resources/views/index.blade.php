            ...
            <div class="row">
                <div class="col-xl-5 col-lg-6 offset-lg-6 offset-xl-7">
                    <div class="banner-content">
                        ...
                        <p>
                            Trade Forex, CFDs and Cryptos on more than 100 world-class assets
                        </p>
                        <div class="button-group">
                            <a href="signup.html" class="custom-button">Get Started Now!</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    <div class="section-header left-style">
                        ...
                        <p>
                            ...
                            EUREX exchange to mention a few. We provide our clients with access to top-tier liquidity and
                            wide range of trading tools, while maintaining security, liquidity, enabling a safe and
                ...
                <div class="col-md-6 col-sm-10 col-lg-4">
                    <div class="feature-item">
                        ...
                        <div class="feature-content">
                            ...
                            <p>Our plans are suited to yield guaranteed profitable returns.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-10 col-lg-4">
                    <div class="feature-item">
                        ...
                        <div class="feature-content">
                            ...
                            <p>Our websites are protected to avoid malicious attempts to disturb normal traffic. </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-10 col-lg-4">
                    <div class="feature-item">
                        ...
                        <div class="feature-content">
                            ...
                            <p>We offer 24/7 cusomer support system to guide our clients. </p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <ul class="tab-menu">
                                <li class="active">
                                    ...
                                    <div class="menu-content">
                                        ...
                                        <p>
                                            Click <a href="#0">Sign Up</a> to fill the blank, our 256 SSL will Protect your
                                            privacy.
                                        </p>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="menu-content">
                                        ...
                                        <p>
                                            <a href="#0">Login</a> into your account and make payments to start earning the
                                            profit.
                                        </p>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="menu-content">
                                        ...
                                        <p>
                                            You get your profit on your profile, also you will get Instant Payment
                                        </p>
                                    </div>
                                </li>
                            </ul>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-xl-7">
                    <div class="section-header">
                        ...
                        <p>
                            Trade Cryptocurrencies, Stock indexes, Commodities and Forex with a single Bitcoin-based
                            platform.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="offer-body">
                        ...
                        <div class="item first">
                            ...
                            <div class="item-content">
                                ...
                                <h5 class="subtitle"><span class="min">$200</span><span class="to">to</span><span
                                        class="max">$1000</span></h5>
                            </div>
                        </div>
                        <span class="bal-shape"></span>
                        <div class="item">
                ...
                <div class="offer-item">
                    ...
                    <div class="offer-body">
                        ...
                        <div class="item first">
                            ...
                            <div class="item-content">
                                <h5 class="title">Deposit</h5>
                                <h5 class="subtitle"><span class="min">$1000</span><span class="to">to</span><span
                                        class="max">$5000</span></h5>
                            </div>
                        </div>
                        <span class="bal-shape"></span>
                        <div class="item">
                ...
                <div class="offer-item">
                    ...
                    <div class="offer-body">
                        ...
                        <div class="item first">
                            ...
                            <div class="item-content">
                                <h5 class="title">Deposit</h5>
                                <h5 class="subtitle"><span class="min">$5000</span><span class="to">to</span><span
                                        class="max">$10,000</span></h5>
                            </div>
                        </div>
                        <span class="bal-shape"></span>
                        <div class="item">
                ...
                <div class="offer-item">
                    ...
                    <div class="offer-body">
                        ...
                        <div class="item first">
                            ...
                            <div class="item-content">
                                <h5 class="title">Deposit</h5>
                                <h5 class="subtitle"><span class="min">$10,000</span><span class="to">to</span><span
                                        class="max">$50,000</span></h5>
                            </div>
                        </div>
                        <span class="bal-shape"></span>
                        <div class="item">
                            ...
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        ...
                                        <span class="date">March 5, 08:57</span>
                                    </div>
                                    ...
                                    <div class="transaction-footer">
                                        ...
                                        <h5 class="sub-title">0.00449751 BTC</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        ...
                                        <span class="date">April 24, 09:57</span>
                                    </div>
                                    <div class="transaction-thumb">
                                        <img src="assets/images/transaction/transaction01.png" alt="transaction">
                                    </div>
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">0.00949725 BTC</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        ...
                                        <span class="date">May 3, 15:37</span>
                                    </div>
                                    <div class="transaction-thumb">
                                        <img src="assets/images/transaction/transaction01.png" alt="transaction">
                                    </div>
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">3.00840721 BTC</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        ...
                                        <span class="date">June 22, 17:20</span>
                                    </div>
                                    <div class="transaction-thumb">
                                        <img src="assets/images/transaction/transaction01.png" alt="transaction">
                                    </div>
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">8.00549921 BTC</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        ...
                                        <span class="date">July 27, 12:27</span>
                                    </div>
                                    <div class="transaction-thumb">
                                    ...
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">5.00449721 USD</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        ...
                                        <span class="date">July 29, 13:20</span>
                                    </div>
                                    <div class="transaction-thumb">
                                        <img src="assets/images/transaction/transaction01.png" alt="transaction">
                                    </div>
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">1.00479721 BTC</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        ...
                                        <span class="date">August 2, 10:57</span>
                                    </div>
                                    <div class="transaction-thumb">
                                        <img src="assets/images/transaction/transaction01.png" alt="transaction">
                                    </div>
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">4.02749724 USD</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        ...
                                        <span class="date">August 12, 10:27</span>
                                    </div>
                                    <div class="transaction-thumb">
                                        <img src="assets/images/transaction/transaction01.png" alt="transaction">
                                    </div>
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">2.01049751 BTC</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center mb-30-none">
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        <h5 class="title">Doug9544</h5>
                                        <span class="date">January 2, 10:30</span>
                                    </div>
                                    <div class="transaction-thumb">
                                        <img src="assets/images/transaction/transaction01.png" alt="transaction">
                                    </div>
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">0.00940721 USD</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        <h5 class="title">Hector 951</h5>
                                        <span class="date">January 22, 17:57</span>
                                    </div>
                                    <div class="transaction-thumb">
                                        <img src="assets/images/transaction/transaction01.png" alt="transaction">
                                    </div>
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">0.00946791 BTC</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        <h5 class="title">KimHowell21</h5>
                                        <span class="date">January 27, 12:17</span>
                                    </div>
                                    <div class="transaction-thumb">
                                        <img src="assets/images/transaction/transaction01.png" alt="transaction">
                                    </div>
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">0.07049781 BTC</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        <h5 class="title">ildar25864</h5>
                                        <span class="date">January 28, 11:57</span>
                                    </div>
                                    <div class="transaction-thumb">
                                        <img src="assets/images/transaction/transaction01.png" alt="transaction">
                                    </div>
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">0.00949720 BTC</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        <h5 class="title">Buha74</h5>
                                        <span class="date">January 29, 12:40</span>
                                    </div>
                                    <div class="transaction-thumb">
                                        <img src="assets/images/transaction/transaction01.png" alt="transaction">
                                    </div>
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">0.00749761 BTC</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        <h5 class="title">Eduardo54</h5>
                                        <span class="date">January 29, 09:37</span>
                                    </div>
                                    <div class="transaction-thumb">
                                        <img src="assets/images/transaction/transaction01.png" alt="transaction">
                                    </div>
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">0.00949729 BTC</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        <h5 class="title">Pedro33</h5>
                                        <span class="date">January 5, 03:20</span>
                                    </div>
                                    <div class="transaction-thumb">
                                        <img src="assets/images/transaction/transaction05.png" alt="transaction">
                                    </div>
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">0.00499625 USD</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        <h5 class="title">Nelson35</h5>
                                        <span class="date">January 28, 02:27</span>
                                    </div>
                                    <div class="transaction-thumb">
                                        <img src="assets/images/transaction/transaction01.png" alt="transaction">
                                    </div>
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">1.32659432 BTC</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center mb-30-none">
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        <h5 class="title">Buha74</h5>
                                        <span class="date">January 10, 01:40</span>
                                    </div>
                                    <div class="transaction-thumb">
                                        <img src="assets/images/transaction/transaction01.png" alt="transaction">
                                    </div>
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">1.00653789 BTC</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        <h5 class="title">Eduardo54</h5>
                                        <span class="date">January 18, 12:50</span>
                                    </div>
                                    <div class="transaction-thumb">
                                        <img src="assets/images/transaction/transaction01.png" alt="transaction">
                                    </div>
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">0.00377854 BTC</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        <h5 class="title">Pedro33</h5>
                                        <span class="date">January 21, 11:17</span>
                                    </div>
                                    <div class="transaction-thumb">
                                        <img src="assets/images/transaction/transaction05.png" alt="transaction">
                                    </div>
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">0.00548321 USD</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        <h5 class="title">Nelson35</h5>
                                        <span class="date">January 21, 17:12</span>
                                    </div>
                                    <div class="transaction-thumb">
                                        <img src="assets/images/transaction/transaction01.png" alt="transaction">
                                    </div>
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">0.00949829 BTC</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        <h5 class="title">Doug9544</h5>
                                        <span class="date">Febuary 2, 10:52</span>
                                    </div>
                                    <div class="transaction-thumb">
                                        <img src="assets/images/transaction/transaction01.png" alt="transaction">
                                    </div>
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">0.00849795 USD</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        <h5 class="title">Hector 951</h5>
                                        <span class="date">Febuary 4, 16:27</span>
                                    </div>
                                    <div class="transaction-thumb">
                                        <img src="assets/images/transaction/transaction01.png" alt="transaction">
                                    </div>
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">0.00649720 BTC</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        <h5 class="title">KimHowell21</h5>
                                        <span class="date">Febuary 14, 18:50</span>
                                    </div>
                                    <div class="transaction-thumb">
                                        <img src="assets/images/transaction/transaction01.png" alt="transaction">
                                    </div>
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">0.00233847 BTC</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                <div class="transaction-item">
                                    <div class="transaction-header">
                                        <h5 class="title">ildar25864</h5>
                                        <span class="date">October 2, 18:37</span>
                                    </div>
                                    <div class="transaction-thumb">
                                        <img src="assets/images/transaction/transaction01.png" alt="transaction">
                                    </div>
                                    <div class="transaction-footer">
                                        <span class="amount">Amount</span>
                                        <h5 class="sub-title">0.00549829 BTC</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-7 col-xl-6">
                    <div class="call-item text-center text-sm-left">
                        ...
                        <div class="call-content">
                            <h5 class="title">Ready To Start Your Earnings Through Forex Trading With Crypto Currency</h5>
                        </div>
                    </div>
                </div>
                <div class="col-md-5 col-xl-6 text-center text-sm-left text-md-right">
                    <a href="about-2.html" class="custom-button">learn more <i class="flaticon-right"></i></a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-10">
                    <div class="section-header left-style">
                        ...
                        <h2 class="title"><span>10,000</span> HAPPY CLIENTS AROUND THE WORLD</h2>
                        <p class="mw-500">
                    ...
                    <div class="m--30">
                        <div class="client-slider owl-carousel owl-theme">
                            ...
                            <div class="client-item">
                                <div class="client-content">
                                    <p>
                                        Very easy to use, perfect for investments
                                    </p>
                                    <div class="rating">
                                        <span>
                                            <i class="fas fa-star"></i>
                            ...
                            <div class="client-item">
                                <div class="client-content">
                                    <p>
                                        Awesome, STS is the most profitable site!
                                    </p>
                                    <div class="rating">
                                        <span>
                                            <i class="fas fa-star"></i>
