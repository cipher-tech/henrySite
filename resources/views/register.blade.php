                                 ...
                                 <x-jet-authentication-card>
                                     ...
                                     <form method="POST" action="{{ route('register') }}">
                                         ...
                                         <div>
                                             ...
                                             <x-jet-input id="full_name" class="block mt-1 w-full" type="text"
                                         ...
                                         <div>
                                             ...
                                             <x-jet-input id="phone_no" class="block mt-1 w-full" type="text"
                                         ...
                                         <div class="form-group">
                                             ...
                                             <select id="country" class="block mt-1 w-full" type="text" name="country"
